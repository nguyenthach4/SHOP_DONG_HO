namespace DongHoShop.Data.Migrations
{
    ...
    public partial class RevenuseStatisticSP : DbMigration
    {
        public override void Up()
        {
            CreateStoredProcedure("GetRevenuseStatistic",
                p => new
                {
                    fromDate = p.String(),
                    toDate = p.String()
                ...
                @"select 
                    ...
                    sum(od.Quantity*od.Price) as Revenuse, 
        ...
        {
            DropStoredProcedure("dbo.GetRevenuseStatistic");
        }
    }
}
